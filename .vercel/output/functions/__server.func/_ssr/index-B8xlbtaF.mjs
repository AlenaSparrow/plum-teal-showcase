...
import { s as smartAlertsPreview, m as miraPreview, r as researchPreview, f as forecastingPreview, u as uworkPreview } from "./mira-preview-CVkWf7IP.mjs";
...
function Work() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "work", className: "mx-auto max-w-7xl px-6 lg:px-10 py-28 lg:py-40", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-24 lg:space-y-32", children: projects.filter((p) => ["smart-alerts", "research", "mira"].includes(p.id)).map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectCard, { project: p, index: i }, p.id)) }),

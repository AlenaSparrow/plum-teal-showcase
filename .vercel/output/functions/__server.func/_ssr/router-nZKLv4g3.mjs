...
const appCss = "/assets/styles-B_SOoFZJ.css";
...
const $$splitComponentImporter$6 = () => import("./contact-PCzSNYFa.mjs");
...
const $$splitComponentImporter$4 = () => import("./index-B8xlbtaF.mjs");
...
const caseStudies = [
  ...
  },
  {
    ...
    tagline: "A multi-year research program that turned how PR and marketing teams build and share dashboards from a fragmented workaround into a unified, trustworthy reporting experience.",
